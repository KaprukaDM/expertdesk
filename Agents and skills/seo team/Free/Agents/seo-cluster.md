...
**Vendored from:** [claude-seo](https://github.com/AgricIDaniel/claude-seo) — `.claude/agents/seo-cluster.md`
**Used in:** Free (universal, always runs — deeper pass for Content/Publisher archetype) + Paid (all tiers)
